...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-3009-3007-{stamp}.sqlite")
...
correct = [
    ("2026-09-14", "3009", "06:04", "16:25"),
    ("2026-09-15", "3009", "06:04", "16:25"),
    ("2026-09-16", "3009", "06:04", "16:25"),
    ("2026-09-17", "3007", "06:03", "14:19"),
    ("2026-09-18", "3007", "06:03", "14:19"),
]

replace_dates = {x[0] for x in correct}
duties = [d for d in duties if d.get("date") not in replace_dates]

for date, number, start, end in correct:
    duties.append({
...
print("Backup:", backup)
print("3009/3007-Woche gespeichert")
...
print()
for d in duties:
    if d.get("date", "").startswith("2026-09"):
        if d.get("type") == "frei":
            print(d["date"], "FREI")
        else:
