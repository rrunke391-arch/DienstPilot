...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-3011-3014-2027-03-29-{stamp}.sqlite")
...
free_date = "2027-03-31"
entries = [
    ("2027-03-29", "3011", "06:23", "17:00"),
    ("2027-03-30", "3011", "06:23", "17:00"),
    ("2027-04-01", "3014", "06:35", "15:39"),
    ("2027-04-02", "3014", "06:35", "15:39"),
]
...
print("Backup:", backup)
print("3011/3014-Woche März/April 2027 gespeichert")
...
for d in duties:
    date = d.get("date", "")
    if date.startswith("2027-03") or date.startswith("2027-04"):
        if d.get("type") == "frei":
            print(d["date"], "FREI")
        else:
