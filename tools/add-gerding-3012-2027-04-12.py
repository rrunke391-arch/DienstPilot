...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-3012-2027-04-12-{stamp}.sqlite")
...
for date in week:
    duties.append({
        "id": f"gerding-{date.replace('-', '')}-3012",
        "date": date,
        "number": "3012",
        "start": "06:31",
        "end": "16:50",
...
print("Backup:", backup)
print("3012-Woche April 2027 gespeichert")
