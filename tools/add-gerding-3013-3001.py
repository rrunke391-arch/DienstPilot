...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-3013-3001-{stamp}.sqlite")
...
entries = [
    ("2026-11-30", "3013", "06:35", "17:06"),
    ("2026-12-01", "3013", "06:35", "17:06"),
    ("2026-12-02", "3001", "05:03", "12:12"),
    ("2026-12-03", "3001", "05:03", "12:12"),
    ("2026-12-04", "3001", "05:03", "12:12"),
]
...
print("Backup:", backup)
print("3013/3001-Woche gespeichert")
...
print()
for d in duties:
    if d.get("date", "").startswith("2026-11") or d.get("date", "").startswith("2026-12"):
        if d.get("type") == "frei":
            print(d["date"], "FREI")
        else:
