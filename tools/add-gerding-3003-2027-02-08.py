...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-3003-2027-02-08-{stamp}.sqlite")
...
for date in week:
    duties.append({
        "id": f"gerding-{date.replace('-', '')}-3003",
        "date": date,
        "number": "3003",
        "start": "05:47",
        "end": "14:10",
...
print("Backup:", backup)
print("3003-Woche Februar 2027 gespeichert")
