...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-3014-3011-2027-05-03-{stamp}.sqlite")
...
free_date = "2027-05-04"
entries = [
    ("2027-05-03", "3014", "06:35", "15:39"),
    ("2027-05-05", "3011", "06:23", "17:00"),
    ("2027-05-06", "3011", "06:23", "17:00"),
    ("2027-05-07", "3011", "06:23", "17:00"),
]

replace_dates = {free_date}
replace_dates.update(date for date, _, _, _ in entries)
duties = [d for d in duties if d.get("date") not in replace_dates]

duties.append({
    "id": "gerding-20270504-frei",
    "date": free_date,
    "type": "frei",
    "number": "",
    "start": "",
...
data["duties"] = duties
data["shownMonths"] = ["2026-08", "2026-09", "2026-10", "2026-11", "2026-12", "2027-01", "2027-02", "2027-03", "2027-04", "2027-05"]
...
print("Backup:", backup)
print("3014/3011-Woche Mai 2027 gespeichert")
