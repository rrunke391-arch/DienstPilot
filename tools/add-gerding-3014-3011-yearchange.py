...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-3014-3011-jahreswechsel-{stamp}.sqlite")
...
free_date = "2026-12-29"
entries = [
    ("2026-12-28", "3014", "06:35", "15:39"),
    ("2026-12-30", "3011", "06:23", "17:00"),
    ("2026-12-31", "3011", "06:23", "17:00"),
    ("2027-01-01", "3011", "06:23", "14:34"),
]
...
print("Backup:", backup)
print("3014/3011-Woche Jahreswechsel gespeichert")
...
for d in duties:
    date = d.get("date", "")
    if date.startswith("2026-12") or date.startswith("2027-01"):
        if d.get("type") == "frei":
            print(d["date"], "FREI")
        else:
