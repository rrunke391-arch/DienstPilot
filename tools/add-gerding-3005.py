...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-3005-{stamp}.sqlite")
...
entries = [
    ("2026-09-28", "3005", "05:51", "15:49"),
    ("2026-09-29", "3005", "05:51", "15:49"),
    ("2026-09-30", "3005", "05:51", "15:49"),
    ("2026-10-01", "3005", "05:51", "15:49"),
]
free_date = "2026-10-02"
replace_dates = {date for date, _, _, _ in entries}
replace_dates.add(free_date)
...
print()
for d in duties:
    if d.get("date", "").startswith("2026-09") or d.get("date", "").startswith("2026-10"):
        if d.get("type") == "frei":
            print(d["date"], "FREI")
        else:
