...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-wd-2027-05-10-{stamp}.sqlite")
...
free_date = "2027-05-13"
entries = [
    ("2027-05-10", "3016", "06:43", "18:06"),
    ("2027-05-11", "3019", "06:49", "17:28"),
    ("2027-05-12", "3012", "06:31", "16:50"),
    ("2027-05-14", "3095", "20:20", "04:05"),
]
...
print("Backup:", backup)
print("WD-Woche Mai 2027 gespeichert")
