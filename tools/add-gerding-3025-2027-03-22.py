...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-3025-2027-03-22-{stamp}.sqlite")
...
for date in week:
    duties.append({
        "id": f"gerding-{date.replace('-', '')}-3025",
        "date": date,
        "number": "3025",
        "start": "13:10",
        "end": "21:50",
...
print("Backup:", backup)
print("3025-Woche März 2027 gespeichert")
