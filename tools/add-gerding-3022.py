...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-3022-{stamp}.sqlite")
...
# vorhandene Einträge in dieser Woche ersetzen
duties = [d for d in duties if d.get("date") not in set(week)]
