...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-3024-2027-04-19-{stamp}.sqlite")
...
for date in week:
    duties.append({
        "id": f"gerding-{date.replace('-', '')}-3024",
        "date": date,
        "number": "3024",
        "start": "12:20",
        "end": "21:05",
...
print("Backup:", backup)
print("3024-Woche April 2027 gespeichert")
