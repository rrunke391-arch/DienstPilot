...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-wd-2026-10-19-{stamp}.sqlite")
...
free_date = "2026-10-19"
entries = [
    ("2026-10-20", "3014", "06:35", "15:39"),
    ("2026-10-21", "3014", "06:35", "15:39"),
    ("2026-10-22", "3006", "06:00", "16:20"),
    ("2026-10-23", "3005", "05:51", "15:49"),
]
...
print("Backup:", backup)
print("WD-Woche 19.10. gespeichert")
