...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-3016-2027-02-15-{stamp}.sqlite")
...
free_date = "2027-02-15"
entries = [
    ("2027-02-16", "3016", "06:43", "18:06"),
    ("2027-02-17", "3016", "06:43", "18:06"),
    ("2027-02-18", "3016", "06:43", "18:06"),
    ("2027-02-19", "3016", "06:43", "18:06"),
]
...
data["duties"] = duties
data["shownMonths"] = ["2026-08", "2026-09", "2026-10", "2026-11", "2026-12", "2027-01", "2027-02"]
...
print("Backup:", backup)
print("3016-Woche Februar 2027 gespeichert")
