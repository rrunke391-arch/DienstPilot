...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-wd-2027-02-22-{stamp}.sqlite")
...
free_date = "2027-02-22"
entries = [
    ("2027-02-23", "3014", "06:35", "15:39"),
    ("2027-02-24", "3014", "06:35", "15:39"),
    ("2027-02-25", "3006", "06:00", "16:20"),
    ("2027-02-26", "3005", "05:51", "15:49"),
]
...
print("Backup:", backup)
print("WD-Woche Februar 2027 gespeichert")
