...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-3006-2027-03-01-{stamp}.sqlite")
...
free_date = "2027-03-04"
entries = [
    ("2027-03-01", "3006", "06:00", "16:20"),
    ("2027-03-02", "3006", "06:00", "16:20"),
    ("2027-03-03", "3006", "06:00", "16:20"),
    ("2027-03-05", "3006", "06:00", "14:21"),
]
...
data["duties"] = duties
data["shownMonths"] = ["2026-08", "2026-09", "2026-10", "2026-11", "2026-12", "2027-01", "2027-02", "2027-03"]
...
print("Backup:", backup)
print("3006-Woche März 2027 gespeichert")
