...
backup = os.path.join(BACKUP_DIR, f"dienstpilot-vor-gerding-wd-2027-01-04-{stamp}.sqlite")
...
free_date = "2027-01-07"
entries = [
    ("2027-01-04", "3016", "06:43", "18:06"),
    ("2027-01-05", "3019", "06:49", "17:28"),
    ("2027-01-06", "3012", "06:31", "16:50"),
    ("2027-01-08", "3095", "20:20", "04:05"),
]
...
print("Backup:", backup)
print("WD-Woche Januar 2027 gespeichert")
