(() => {
  ...
  if (window.__dienstpilotDailyPlanImmediateRefreshV6) {
    window.__dienstpilotHolidayUiRepairV3?.restart?.();
    window.__dienstpilotHolidayUiRepairV2?.restart?.();
    window.__dienstpilotHolidayUiRepairV1?.restart?.();
    return;
  }
  window.__dienstpilotDailyPlanImmediateRefreshV6 = true;
  ...
  function loadRepairs() {
    const api = window.__dienstpilotHolidayUiRepairV3
      || window.__dienstpilotHolidayUiRepairV2
      || window.__dienstpilotHolidayUiRepairV1;
    if (api?.restart) api.restart();
    else loadScript('dpHolidayUiRepairV3', 'src/holiday-ui-repair.js?v=20260723-3');
